...
data <- import("tables/table_S3.txt", header = TRUE)
...
table_S3 <- kbl(data, 
               ...
               align = c("l", "c", "c", "c", "c"),
               caption = "Poisson regression with full count as dependent variable",
               escape = FALSE) %>% 
  ...
  footnote(general = "Generalized linear regression with author and year fixed effects. Standard errors are HC1 and clustered at the author level.",
           ...
           symbol = "Adj. Pseudo R<sup>2</sup> = 0.1957, BIC = 10,828,121.8.",
