...
data <- import("tables/table_S6.txt", header = TRUE)
...
table_S6 <- kbl(data, 
                ...
                align = c("l", "c", "c", "c", "c"),
                caption = "OLS linear regression of full and fractional count as dependent variable, placebo test of 2018 vs. 2019.",
                escape = FALSE,
                format = "html") %>% 
